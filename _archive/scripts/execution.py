...
This root-level execution generator belongs to the older family/artifact pipeline.
It is retained for compatibility and historical workflows, not as the canonical
default surface for new package-first development.
"""
